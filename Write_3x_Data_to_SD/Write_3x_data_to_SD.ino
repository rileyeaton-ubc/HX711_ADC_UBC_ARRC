...
const int HX711_sck_3 = 9; // mcu > HX711 no 4 sck pin
HX711_ADC LoadCell_1(HX711_dout_1, HX711_sck_1); // HX711 1
HX711_ADC LoadCell_2(HX711_dout_2, HX711_sck_2); // HX711 2
HX711_ADC LoadCell_2(HX711_dout_3, HX711_sck_3); // HX711 2
...
const float CALIBRATION_VALUE_3 = LoadCell.getCal_LoadCellC();
...
void setup() {
  ...
  csvLogFile.println("Time (ms), Load Cell 1 Weight (g), Load Cell 2 Weight (g), Load Cell 3 Weight (g)");
  csvLogFile.flush();
  ...
  if (newDataReady) {
    ...
    if (millis() > t + csv_write_delay) {
      ...
      if (csvLogFile) {
        ...
        csvLogFile.print(",");
        csvLogFile.println(loadcell_3_val);
